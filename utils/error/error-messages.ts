import { ACCOUNT_DISABLED_ERROR, DEFAULT_ERROR, EMAIL_ALREADY_VERIFIED_ERROR, FILE_NOT_FOUND_ERROR, FILE_TOO_LARGE_ERROR, FORBIDDEN_ERROR, INTERNAL_ERROR, INVALID_INPUT_ERROR, INVALID_TOKEN_ERROR, MISSING_CREDENTIALS_ERROR, PASSWORD_REQUIRED_ERROR, TOKEN_ALREADY_SENT_ERROR, TOKEN_EXPIRED_ERROR, TOKEN_NOT_FOUND_ERROR, UNAUTHORIZED_ERROR, USER_ALREADY_EXISTS_ERROR, USER_NOT_FOUND_ERROR, USER_UNEDITABLE_ERROR, WRONG_FILE_FORMAT_ERROR, WRONG_PASSWORD_ERROR } from './error-codes';
