...
import { cn, getValidChildren } from '@/utils/ui.util';
	...
	(
		...
		const clones = validChildren.map((child) => {
			...
			if (child.type === BreadcrumbSeparator) {
				return React.cloneElement(child, { children: separator || child.props.children });
			}
		...
		return (
			...
			>
				{ clones }
				{ !isLastChild && addSeparator ? <BreadcrumbSeparator>{ separator }</BreadcrumbSeparator> : null }
			</li>
		);
	}
);
