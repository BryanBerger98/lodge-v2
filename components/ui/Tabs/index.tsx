...
>(({ className, variant = 'default', ...props }, ref) => (
	<TabsPrimitive.Trigger
		className={ cn(
			...
			{ 'text-destructive/80 hover:bg-secondary/80 hover:text-destructive data-[state=active]:bg-secondary data-[state=active]:text-destructive': variant === 'destructive' },
			className
		) }
		ref={ ref }
		{ ...props }
